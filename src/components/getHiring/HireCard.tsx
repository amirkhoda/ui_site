...
const HireCard: React.FC<HireCardProps> = ({ data }) => {
  ...
  return (
    <div className="w-[250px] h-[250px] bg-white shadow-xl gap-4 flex flex-col justify-start items-start p-8 transition-transform duration-200 hover:scale-105 border rounded-lg">
